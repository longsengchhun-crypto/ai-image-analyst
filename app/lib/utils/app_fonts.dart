...
/// Per-locale typography: **Plus Jakarta Sans** for English, **Kantumruy Pro
/// Bold** for Khmer — per product requirement, every piece of Khmer text in
/// the app uses the bold weight of Kantumruy Pro regardless of the weight an
...
/// inline; [appTextTheme] is for the app-wide `ThemeData`
...
TextTheme appTextTheme({required bool khmer, required TextTheme base}) {
  if (!khmer) return GoogleFonts.plusJakartaSansTextTheme(base);
